  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 padding p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"
      }
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          href={"/authenticate"}
          className={
            pathname.includes("/authenticate") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="currentColor"
            className={
              pathname.includes("/authenticate") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
